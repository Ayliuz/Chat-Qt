...
Dialog::Dialog(QWidget *parent) :QDialog(parent), ui(new Ui::Dialog)
{
    ...
    connect(this, SIGNAL(sigMessageFromServer(QString,QStringList)), server, SLOT(slotMessageFromServer(QString,QStringList)));
    ...
    connect(server, SIGNAL(sigMessageToLog(QString,QString,QStringList)), this, SLOT(slotNewMessage(QString,QString,QStringList)));
    connect(this, SIGNAL(sigServerStop()), server, SLOT(slotServerStop()));

    if (server->startServer(QHostAddress::LocalHost, 1234))
    {
